            ...
            <div className="rounded-2xl overflow-hidden w-full flex flex-col-reverse md:flex-row">
                ...
                <div className="md:w-2/3 p-6 space-y-4 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <p>
                        ...
                        backend.
                        Actuellement en licence en Écosystème Logiciel à la <a target="_blank" className="underline text-blue-500 dark:text-blue-300 hover:text-blue-700 dark:hover:text-blue-400 transition" href="https://hei.school">Haute École
                    ...
                    <p>
                        Je connais également des outils comme Git, Docker, Postma
                        n, et je m&#39;intéresse aux bonnes
                        pratiques :
